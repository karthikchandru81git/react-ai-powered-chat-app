                            ...
                            relative whitespace-normal`}>
                                {
                                    isAssistant ?
                                        (isLastChatMessage ?
                                            <>
                                                <BotMessageSquare className='absolute top-0 -left-10 text-white/90 w-[25px] h-[25px]' />
                                            ...
                                            )) : (<><p>{chat.name}</p><User className='absolute top-0 -right-10 text-white/90 w-[25px] h-[25px]' /></>)
                                }
                            </li>
                        )
                    })))
