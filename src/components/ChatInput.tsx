    ...
    return (
        <div className='chatbotInputParent relative w-[93%] z-[350]'>
            <div className={`chatbotInput fixed bottom-[250px] w-[55%] left-[50%] translate-x-[-50%] ${position} `}>
                <h1 className='welcomeText !text-white relative !text-[25px] mb-20 !font-normal tracking-normal'>Hello <strong>{capitalizeFirstLetter(username, true)}</strong>, <span>{greetMessage}</span> How can I help you today?</h1>
                <form onSubmit={handleSubmit} className='relative'>
                    <input type="text" value={value}
                        placeholder='Ask anything'
                        onChange={handleUserInput}
                        className='bg-[#FFFFFF] text-gray-900 py-[15px] px-[20px] border-1 border-gray-500 rounded-[25px] w-[74%] my-0 mx-[auto] outline-0 text-[18px] shadow-[2px_2px_60px_2px_rgba(0,0,0,0.5)]' />
